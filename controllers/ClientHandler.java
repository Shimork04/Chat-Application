...
public class ClientHandler implements Runnable {
    ...
    public void run() {
        try {
            ...
            MessageService.broadcastMessage(room, "Server", username + " has joined the chat!");
            ...
            while ((message = in.readLine()) != null) {
                if (message.equalsIgnoreCase("exit")) {
                    ...
                    out.println("Active users in the chat room:");
            ...
            // Remove the user from the active users list when they leave
            room.removeUser(username);
            MessageService.broadcastMessage(room, "Server", username + " has left the chat!");
